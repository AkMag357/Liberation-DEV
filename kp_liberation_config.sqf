...
GRLIB_fob_range = 160;                                                  // Build range around the main FOB building.
GRLIB_halo_altitude = 700;                                             // Altitude in metres for the HALO jump.
...
GRLIB_capture_size = 120;                                               // Range to capture a sector.
...
GRLIB_vulnerability_timer = 120;                                       // Time in seconds how long a captured sector is vulnerable to enemy troops.
...
GRLIB_patrol_cap = 1;                                                 // Cap for enemy patrols.
...
KP_liberation_resistance_tier2 = 80;                                    // At which strength (0-100) the guerilla forces will be at tier 2?
KP_liberation_resistance_tier3 = 100;                                    // At which strength (0-100) the guerilla forces will be at tier 3?
KP_liberation_resistance_at_chance = 10;                                // Chance that a guerilla unit has a RPG. (tier 2 and 3)
...
KP_liberation_commander_actions = ["76561198252612568",
"76561198154738967",
"76561198056814087",
"76561198413318979",
"76561198123030112",
